...
| 03_Turing_Machine | Turing Machine with tap tempo clock, 2 x pulse outputs, 4 x CV outputs | 1.5.3 | C++ (ComputerCard) | Tom Whitwell | https://www.musicthing.co.uk/web_config/turing.html |  | Working but Simple |
...
| 06_usb_audio | 6-Channel USB Audio & MIDI firmware with CV/Gate support | 1.0 | C++ (RPi Pico SDK) | Workshop System |  | USB Audio & MIDI | Release |
...
| 41_blackbird | A scriptable, live-codable, USB-serial-to-CV device implementing monome crow's protocol | 1.1 | Pico SDK + Lua | Dune Desormeaux | https://dessertplanet.github.io/web-druid/ |  | Released |
