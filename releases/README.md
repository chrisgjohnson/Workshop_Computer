...
| 03_Turing_Machine | Turing Machine with tap tempo clock, 2 x pulse outputs, 4 x CV outputs | 1.5.3 | C++ (ComputerCard) | Tom Whitwell | [Link](https://www.musicthing.co.uk/web_config/turing.html) | Working but Simple |
...
| 06_usb_audio | 6-Channel USB Audio & MIDI firmware with CV/Gate support | 1.0 | C++ (RPi Pico SDK) | Workshop System |  | Release |
| 07_bumpers | 'Bouncing ball' style delay and trigger generators | 1.0 | C++ (ComputerCard) | Chris Johnson |  | Released |
...
| 12_am_coupler | AM radio transmitter / coupler | 1.0 | C++ (ComputerCard) | Chris Johnson |  | Released |
| 13_noisebox |  |  |  |  |  |  |
| 14_cvmod | Quad CV delay inspired by Make Noise Multimod | 1.0 | C++ (ComputerCard) | Chris Johnson |  | Released |
| 18_chord_organ | Chord Organ - 16 chords, 8 voices, 1V/oct root. Replicates Music Thing Chord-Organ. | 0.1 | Pico SDK (C++), ComputerCard | Workshop System |  | Working |
| 20_reverb | Reverb effect, plus pulse/CV generators and MIDI-to-CV, configurable using web interface. | 1.4 | C (RPi Pico SDK) | Chris Johnson | [Link](https://www.musicthing.co.uk/web_config/reverb.html) | Released |
| 21_resonator |  |  |  |  |  |  |
...
| 25_utility_pair | 25 small utilities, which can be combined in pairs | 1.0 | C++ (ComputerCard) | Chris Johnson |  | Released |
...
| 32_vink | Dual delay loops with sigmoid saturation for Jaap Vink / Roland Kayn style feedback patching | 1.1 | C++(ComputerCard) | Ben Regnier |  | Functional |
...
| 41_blackbird | A scriptable, live-codable, USB-serial-to-CV device implementing monome crow's protocol | 1.1 | Pico SDK + Lua | Dune Desormeaux | [Link](https://dessertplanet.github.io/web-druid/) | Released |
